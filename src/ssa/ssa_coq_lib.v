...
(**********************************)
(* Definition dec for basic types, which can be refined for extraction. *)

Definition id_dec := eq_atom_dec.
Definition l_dec := eq_atom_dec.
Definition INT_dec := eq_nat_dec.
Definition sz_dec := eq_nat_dec.
Definition align_dec := eq_nat_dec.
Definition inbounds_dec := bool_dec.
Definition tailc_dec := bool_dec.
Definition noret_dec := bool_dec.
...
Definition list_id_lEqB (idls idls':list_id_l) := sumbool2bool _ _ (list_id_l_dec idls idls').
