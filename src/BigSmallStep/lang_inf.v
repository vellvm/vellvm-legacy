...
Inductive degree_exp_wrt_exp : nat -> exp -> Prop :=
  | degree_wrt_exp_const : forall n1,
    degree_exp_wrt_exp n1 (const)
...
Definition degree_exp_wrt_exp_mutind :=
  fun H1 H2 H3 H4 H5 H6 =>
  degree_exp_wrt_exp_ind' H1 H2 H3 H4 H5 H6.
