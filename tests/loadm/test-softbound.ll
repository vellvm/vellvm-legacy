...
@.str24 = internal constant [18 x i8] c"../../softbound.c\00"		; <[18 x i8]*> [#uses=1]
...
bb2:		; preds = %bb1, %entry
	...
	%ptr.0_base = phi i8* [ undef, %entry ], [ %base.load2, %bb1 ]		; <i8*> [#uses=1]
	%ptr.0_bound = phi i8* [ undef, %entry ], [ %bound.load3, %bb1 ]		; <i8*> [#uses=1]
	%safe.phi_node = phi i32 [ 0, %entry ], [ %safe.ptr.load, %bb1 ]		; <i32> [#uses=1]
...
bb5:		; preds = %bb4
	tail call void @__assert_fail(i8* getelementptr ([43 x i8]* @.str13, i32 0, i32 0), i8* getelementptr ([18 x i8]* @.str24, i32 0, i32 0), i32 106, i8* getelementptr ([17 x i8]* @__PRETTY_FUNCTION__.3087, i32 0, i32 0)) noreturn nounwind
	unreachable
