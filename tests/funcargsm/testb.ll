...
define void @test(i32 %mm, i32** nocapture %value) nounwind {
entry:
	%0 = load i32** %value, align 4		; <i32*> [#uses=3]
...
bb:		; preds = %bb, %entry
	...
	%2 = getelementptr i32* %0, i32 %ptr.04.sum		; <i32*> [#uses=1]
	%3 = load i32* %2, align 4		; <i32> [#uses=1]
	%.rec9 = add i32 %.rec8, %3		; <i32> [#uses=2]
	%4 = getelementptr i32* %0, i32 %.rec9		; <i32*> [#uses=2]
...
bb2:		; preds = %bb, %entry
	...
	%6 = tail call i32 (i8*, ...)* @printf(i8* noalias getelementptr ([4 x i8]* @.str, i32 0, i32 0), i32* %.lcssa) nounwind		; <i32> [#uses=0]
	ret void
}
