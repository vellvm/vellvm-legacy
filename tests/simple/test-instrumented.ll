...
entry:
	%0 = malloc [10 x i32]		; <[10 x i32]*> [#uses=4]
	...
	%.sub = getelementptr [10 x i32]* %0, i32 0, i32 0		; <i32*> [#uses=2]
	%1 = getelementptr [10 x i32]* %0, i32 0, i32 %mm		; <i32*> [#uses=2]
	...
	%bcast_ld_dref_bound = bitcast i32* %.sub to i8*		; <i8*> [#uses=1]
	...
	%3 = tail call i32 (i8*, ...)* @printf(i8* noalias getelementptr ([4 x i8]* @.str1, i32 0, i32 0), i32 %2) nounwind		; <i32> [#uses=0]
	ret void
}
