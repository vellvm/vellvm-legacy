...
Lemma undefined_state__laa_State_simulation_l2r: forall pinfo laainfo cfg1 St1 cfg2
...
Lemma undefined_state__laa_State_simulation_r2l: forall pinfo laainfo cfg1 St1 cfg2
  St2 (Hstsim : State_simulation pinfo laainfo cfg1 St1 cfg2 St2),
...
Proof.
  ...
  induction Hopstar; intros.
    ...
    destruct J as [Hfinal1 | [[IS1' [tr0 Hop1]] | Hundef1]].
      apply s_isFinialState__laa_State_simulation in Hstsim.
      ...
      eapply undefined_state__laa_State_simulation_l2r in Hstsim; eauto.
...
| H: Opsem.s_genInitState [module_intro ?los ?nts _] _ _ _ = _,  
  ...
  |- _ =>
    ...
    | H1: Opsem.s_isFinialState _ _ = _ |- _ =>
      erewrite <- s_isFinialState__laa_State_simulation in H1; eauto
    end.
    econstructor; eauto.
